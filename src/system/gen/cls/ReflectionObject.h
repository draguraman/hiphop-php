...
#ifndef __GENERATED_cls_ReflectionObject_h8fef8271__
#define __GENERATED_cls_ReflectionObject_h8fef8271__
...
class c_ReflectionObject : public c_ReflectionClass {
  ...
  c_ReflectionObject(const ObjectStaticCallbacks *cb = &cw_ReflectionObject) : c_ReflectionClass(cb), m_obj(Variant::nullInit) {}
  public: void t___construct(Variant v_obj);
  public: c_ReflectionObject *create(CVarRef v_obj);
...
#endif // __GENERATED_cls_ReflectionObject_h8fef8271__
